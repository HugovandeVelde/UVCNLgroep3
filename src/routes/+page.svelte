<script>
    ...
    import { isAuthenticated, user, user_tasks, tasks } from "/src/store";
    import TaskItem from "/src/lib/components/TaskItem.svelte";
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <span class="navbar-text">
          <ul class="navbar-nav float-right">
            ...
            {:else}
            <li class="nav-item">
              <a class="nav-link" href="/http://localhost:5173/frontPage" on:click="{login}">Log In</a>
            </li>
            {/if}
          </ul>
        </span>
